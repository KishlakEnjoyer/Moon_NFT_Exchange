...
- **Frontend**: React/Vue.js, Web3.js, Ethers.js
- **Backend**: Node.js, Express/FastAPI
- **Блокчейн**: Solidity, Hardhat/Truffle, IPFS (для хранения метаданных)
- **База данных**: PostgreSQL/MongoDB
- **Деплой**: Docker, AWS/Heroku, Infura/Alchemy
